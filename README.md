# Next13-Tailwind-Connectkit-Nakama
...
```bash
yarn create next-app [project-name] -e https://github.com/nelwincatalogo/next13-connectkit-nakama
```

OR

```bash
npx create-next-app [project-name] -e https://github.com/nelwincatalogo/next13-connectkit-nakama
```
